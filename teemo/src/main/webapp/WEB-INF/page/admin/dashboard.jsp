...
<head>
    ...
    <!-- Morris -->
    <link href="${staticPath}/static/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="${staticPath}/static/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<!-- Flot -->
<script src="${staticPath}/static/js/plugins/flot/jquery.flot.js"></script>
<script src="${staticPath}/static/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="${staticPath}/static/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="${staticPath}/static/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="${staticPath}/static/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="${staticPath}/static/js/plugins/flot/jquery.flot.symbol.js"></script>
...
<!-- jQuery UI -->
<script src="${staticPath}/static/js/plugins/jquery-ui/jquery-ui.min.js"></script>

<!-- Jvectormap -->
<script src="${staticPath}/static/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${staticPath}/static/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- EayPIE -->
<script src="${staticPath}/static/js/plugins/easypiechart/jquery.easypiechart.js"></script>

<!-- Sparkline -->
<script src="${staticPath}/static/js/plugins/sparkline/jquery.sparkline.min.js"></script>

<!-- Sparkline demo data  -->
<script src="${staticPath}/static/js/demo/sparkline-demo.js"></script>
