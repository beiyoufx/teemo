...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear">
                                <span class="block m-t-xs"><strong class="font-bold">${CurrentUser.nickname}</strong></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="${ctx}/dashboard" data-index="0">仪表盘</a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                            ...
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${staticPath}/static/img/a7.jpg">
                                    </a>
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/dashboard" frameborder="0" data-id="${ctx}/dashboard" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2016- <a href="https://github.com/beiyoufx" target="_blank">北有风雪</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
        ...
        <div id="tab-2" class="tab-pane">
            ...
            <div>
                ...
                <div class="sidebar-message">
                    <a href="#">
                        <div class="pull-left text-center">
                            <img alt="image" class="img-circle message-avatar" src="${staticPath}/static/img/a2.jpg">
                        </div>
                        <div class="media-body">
                ...
                <div class="sidebar-message">
                    <a href="#">
                        <div class="pull-left text-center">
                            <img alt="image" class="img-circle message-avatar" src="${staticPath}/static/img/a3.jpg">
                ...
                <div class="sidebar-message">
                    <a href="#">
                        <div class="pull-left text-center">
                            <img alt="image" class="img-circle message-avatar" src="${staticPath}/static/img/a4.jpg">
                        </div>
                ...
                <div class="sidebar-message">
                    <a href="#">
                        <div class="pull-left text-center">
                            <img alt="image" class="img-circle message-avatar" src="${staticPath}/static/img/a8.jpg">
                        </div>
                        <div class="media-body">
                ...
                <div class="sidebar-message">
                    <a href="#">
                        <div class="pull-left text-center">
                            <img alt="image" class="img-circle message-avatar" src="${staticPath}/static/img/a7.jpg">
                        </div>
                        <div class="media-body">
