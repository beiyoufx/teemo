                ...
                <div class="col-sm-12">
                    ...
                    <div class="table-wrap">
                        ...
                        <div class="user-table">
                            <table id="userTablePagination" data-toggle="table" data-mobile-responsive="true" data-height="600" data-icon-size="outline">
                                <thead>
                                <tr>
...
<!-- Peity -->
<script src="${staticPath}/static/js/demo/bootstrap-table-demo.js?time=20161207.1403"></script>
<script>
    $table = $('#userTablePagination');
    // Bootstrap Table
    (function() {
    ...
    function optionFormatter(value, row, index) {
        var authHtml = "&nbsp;<shiro:hasPermission name="sys:auth:update"><button type='button' class='fa fa-edit btn btn-success' onclick='auth(" + row.id + ")'>授权</button></shiro:hasPermission>&nbsp;";
        ...
        var deleteHtml = "&nbsp;<shiro:hasPermission name="sys:user:delete"><button type='button' class='delete fa fa-times btn btn-default' onclick='deleteUser(" + row.id + ")'>删除</button></shiro:hasPermission>&nbsp;";
    ...
    parent.layer.confirm('删除之后不可恢复，您确定要删除该用户吗？', {
            ...
            $.ajax({
                url : getContextPath() + "/sys/user/delete/" + userId,
                type : "post",
                async : false,
